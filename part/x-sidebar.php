...
<!-- LEFT -->
          <div class="span3">
                ...
                <div> <!-- class="" data-spy="affix" data-offset-top="320" -->
                        ...
                        <ul id="myTab" class="nav nav-tabs">
                          <li class="active">
                            <a href="#Archives" data-toggle="tab" rel="tooltip" title="Archives"><i class="general foundicon-calendar"></i></a>
                          </li>
                          <li class="">
                            <a href="#HashTagCloud" data-toggle="tab" rel="tooltip" title="Hashtags"><span class="">#</span></a>
                          </li>
                          <li>
                            <a href="#Search" data-toggle="tab" rel="tooltip" title="Search"><i class="general foundicon-search"></i></a>
                          </li>
                          <li>
                            <a href="#Stats" data-toggle="tab" rel="tooltip" title="Profile"><i class="general foundicon-graph"></i></a>
                          </li>
                          <!--  --> <!--
                          LIVE
                                          <li>
                          ...
                          -->
                          <li>
                            <a href="#ColourCloud" data-toggle="tab" rel="tooltip" title="Colour Variations"><i class="general foundicon-settings"></i></a>
                          </li>
                        </ul>
                                ...
                                <div class="tab-pane fade active in" id="Archives">
                                  ...
                                  <table class="table table-hover">
                                      <tbody>
                                        ...
                                        <?php get_template_part ('part/arccloud') ; ?>
                                        ...
                                        <tr>
                                          <td class="datacloud noBord">
                                            <div class="cloudContain">
                                              ...
                                              <?php get_template_part ('part/hashcloud') ; ?>
